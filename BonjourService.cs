    ...
    static class BonjourService
    {
        ...
        static public void Start()
        {
            try
            {
                ...
                service.Register(0, 0, Properties.Settings.Default.ServiceName, "cisterarb._tcp.local", null, null, (ushort)Properties.Settings.Default.ServicePort, null, eventManager);
            }
            catch
            {
